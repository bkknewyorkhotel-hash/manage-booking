...
const translations = {
    TH: {
        ...
        paymentBreakdownHeader: 'การชำระเงิน BREAKDOWN',
        roomRevenue: 'ยอดขายห้องพัก',
        cashInLabel: 'cashIn (TX)',
        cashOutLabel: 'cashOut (TX)',
        netCashInDrawer: 'เงินสดสุทธิ',
        totalRevenue: 'รายได้รวมทั้งหมด',
        paymentHeader: 'การชำระเงิน',
        cashInDrawerTitle: '**** เงินในลิ้นชัก ****',
        cashOpenClose: 'เงินสด (เปิด / ปิด)',
        actualCashValue: 'เงินสดตามมูลค่าจริง',
        cashInOutDrawer: 'เงินเข้า-ออกลิ้นชักคงเหลือ',
        ...
        viewShiftSummary: 'ดูสรุปกะ / พิมพ์',
        pleaseEnterClosingCash: 'กรุณากรอกยอดเงินสดปิดกะก่อน',
    ...
    EN: {
        ...
        cashInDrawerTitle: '**** Cash in Drawer ****',
        cashOpenClose: 'Cash (Open / Close)',
        actualCashValue: 'Actual Cash Value',
        cashInOutDrawer: 'Cash In-Out of Drawer',
        cashInDrawer: 'Cash In',
        cashOutDrawer: 'Cash Out',
        overShortCash: 'Over / Short Cash',
        ...
        viewShiftSummary: 'View Summary / Print',
        pleaseEnterClosingCash: 'Please enter closing cash amount first',
