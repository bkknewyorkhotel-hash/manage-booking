        ...
        <Shell>
            <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <HousekeepStat label="To Inspect" count={rooms.filter(r => r.status === 'INSPECTING').length} color="text-cyan-600 bg-cyan-50" />
...
function HousekeepStat({ label, count, color }: any) {
    return (
        <div className={cn("p-4 border rounded-xl shadow-sm", color)}>
